...
interface ToData<T> : IEquatable<T> where T : ToData<T> {
	Dat toDat();
}

public class ParentPointer : System.Attribute {} // Like an UpPointer, but should be completely ignored for serialization.
public class UpPointer : System.Attribute {}
public class NotData : System.Attribute {}
